...
$students = array(
    array("first_name" => "John", "last_name" => "Doe", "favorite_color" => "Blue", "hobbies" => array("Basketball", "Theatre", "Literature")),
    ...
    array("first_name" => "Daniel", "last_name" => "Lee", "favorite_color" => "Black", "hobbies" => array("Literature", "Soccer", "Cooking")),
